...
struct Tier1FITasks {
    ...
    static let tasks = [
        ...
        Task(
        template:            "{player1}, jos olisit peruna, tulisitko mieluummin kuorituksi vai keitetyksi?",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:            "{player1}, nimeä 4 James Bond -näyttelijää 10:ssä sekunnissa. Epäonnistumisesta {penalties} rankaisevaa",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:            "{player1}, imitoi jotain näyttelijää 10 sekunnin ajan",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
