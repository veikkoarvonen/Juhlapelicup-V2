...
struct Tier1ENTasks {
    ...
    static let tasks = [
        ...
        Task(
        template:            "{player1}, say something sensible in as many languages as you can. For each language, others take {penalties} penalties",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:            "{player1}, name 5 NATO countries in 10 seconds or take {penalties} penalties",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:            "{player1}, imitate a politician of your choice for 10 seconds, or take {penalties} penalties",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
