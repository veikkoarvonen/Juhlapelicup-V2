...
struct Tier2ENTasks {
    ...
    static let tasks = [
        ...
        Task(
        template:                    "{player1}, what's a weird habit that you have? Everyone who hasn’t done it takes {penalties} penalties.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:                    "{player1}, impersonate one of the other players for 10 seconds.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:                    "{player1}, give each player a funny nickname.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        template:                    "{player1}, hug {player2}.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:                    "{player1}, imitate a lion for 15 seconds.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
        ...
        Task(
        template:                    "{player1}, act like a baby for {penalties} rounds or take {penalties} penalties.",
        pointsToScore: 1,
        baselinePenalty: 3
        ),
        Task(
