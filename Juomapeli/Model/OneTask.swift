...
//The getNumber function inserts a number in the string calculated by game parameters
        ...
        self.normalsFI = [
            ...
            "\(player1), nimeä 7 Disney-prinsessaa 15 sekunnissa tai ota \(getNumber(input: 3)) rankaisevaa",
...
//MARK: - English tasks
        ...
        "\(player1), name 5 countries starting with the letter S in 10 seconds or take \(getNumber(input: 3)) penalties",
        "\(player1), name 7 Disney princesses in 10 seconds or take \(getNumber(input: 3)) penalties",
        ...
        "\(player1), moan every time you take a penalty for the rest of the game. Everytime you forget, take \(getNumber(input: 2)) penalties",
        ...
        "\(player1), find out which player has the smelliest feet or take \(getNumber(input: 6)) penalties",
        ...
        "\(player1), if your phone's screen time is higher than \(player2)'s, take \(getNumber(input: 3)) penalties. Otherwise, \(player2) takes \(getNumber(input: 3)) penalties",
        ...
        self.tier1EN = [
            ...
            self.tier2EN = [
                "\(player1), what's the longest you've gone without brushing your teeth? Answer or take \(getNumber(input: 2)) penalties.",
                    ...
                    "\(player1), what's a weird habit that you have? Everyone who hasn’t done it takes \(getNumber(input: 3)) penalties.",
                    ...
                    "\(player1), let player \(player2) style your hair for the rest of the game or take \(getNumber(input: 4)) penalties.",
                    "\(player1), what's the most embarrassing situation you've been in? Answer or take \(getNumber(input: 3)) penalties.",
                    "\(player1), imitate a celebrity until others guess who it is. If you fail, take \(getNumber(input: 4)) penalties.",
                    ...
                    "\(player1), play an air guitar for 15 seconds or take \(getNumber(input: 4)) penalties.",
                    ...
                    "Everyone imitates an animal in turn. The worst one takes \(getNumber(input: 3)) penalties.",
                    "\(player1), jump as high as you can. If the others aren’t convinced, take \(getNumber(input: 3)) penalties.",
                    "\(player1), hold a plank position for one minute. If you fail, take \(getNumber(input: 5)) penalties.",
            ...
            self.tier3EN = [
                "\(player1), what’s the longest you’ve gone without showering? Answer or take \(getNumber(input: 3)) penalties.",
                    ...
                    "\(player1), however many push-ups you do, \(player2) takes that many penalties",
                    "\(player1), burp or take \(getNumber(input: 3)) penalties",
                    "\(player1), if you had to roleplay with \(player2), what characters would you choose?",
                    "\(player1), are you currently crushing on someone? Answer or take \(getNumber(input: 3)) penalties.",
                    "\(player1), have you ever eaten your booger? Answer or take \(getNumber(input: 4)) penalties",
                    "\(player1), do 10 push-ups or take \(getNumber(input: 4)) penalties",
                    "\(player1), show the most recent photo from your Hidden album or take \(getNumber(input: 3)) penalties",
                    "\(player1), take off your shirt for the rest of the game or take \(getNumber(input: 4)) penalties",
                    ...
                    "\(player1), show the sexiest face you can make or take \(getNumber(input: 3)) penalties",
                    ...
                    "\(player1), what’s the most awkward situation on a date you’ve experienced? Answer or take \(getNumber(input: 3)) penalties",
            ...
            "\(player1), describe the last NSFW video you watched or take \(getNumber(input: 4)) penalties",
            "\(player1), freestyle rap about: 'I want to make love to \(player2)'. Refusing means \(getNumber(input: 4)) penalties",
            "\(player1), remove 2 clothing items of your choice or take \(getNumber(input: 4)) penalties",
            ...
            "\(player1), let \(player2) wear your bra. If you don’t have one or you refuse, take \(getNumber(input: 5)) penalties",
            ...
            "\(player1), guess the color of \(player2)'s underwear. If you guess right, they take \(getNumber(input: 3)) penalties. If wrong, you take \(getNumber(input: 3))",
            ...
            "\(player1), describe the last NSFW video you watched or take \(getNumber(input: 5)) penalties",
            "\(player1), twerk for 10 seconds or take \(getNumber(input: 5)) penalties",
            "\(player1), strip to your underwear for the rest of the game or take \(getNumber(input: 4)) penalties",
            "\(player1), remove 3 pieces of clothing of your choice or take \(getNumber(input: 4)) penalties",
            ...
            "\(player1), let \(player2) spank your butt or take \(getNumber(input: 4)) penalties",
            "\(player1), bend over for the other players or take \(getNumber(input: 3)) penalties",
            "\(player1), sing the fast part from Eminem's 'Rap God' as well as you can. Other players decide if you’re spared from \(getNumber(input: 3)) penalties",
